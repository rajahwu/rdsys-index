...
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'grindline.dark', '#2E2E2E', '46, 46, 46', '70, 64, 62, 60', 'Black 7 C', 'Asphalt Gray — base dark, urban grounding, night grind', 1),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'grindline.teal', '#00A6A6', '0, 166, 166', '75, 10, 30, 0', '3262 C', 'Electric Teal — energy, modernity, movement, primary accent', 1),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'grindline.coral', '#FF5A5F', '255, 90, 95', '0, 70, 60, 0', '178 C', 'Burnt Coral — passion, urgency, call to action', 1),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'grindline.gold', '#FFC857', '255, 200, 87', '0, 20, 70, 0', '1225 C', 'Warm Gold — achievement, spotlight, success moments', 1),

-- Neutral colors    
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'neutral.light', '#F3F3F3', '243, 243, 243', '4, 3, 3, 0', 'Cool Gray 1 C', 'Light backgrounds, clean surfaces', 0),    
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'neutral.mid', '#6B7280', '107, 114, 128', '45, 35, 28, 5', 'Cool Gray 8 C', 'Secondary text, muted content', 0),    
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'neutral.white', '#FFFFFF', '255, 255, 255', '0, 0, 0, 0', 'White', 'Pure white — overlays, high contrast', 0);
...
VALUES  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'services', 'brand-systems', 'icons/services/brand-systems.svg', '24x24', '2.5px', 'Brand Systems — modular blocks, construction', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'services', 'creative-production', 'icons/services/creative-production.svg', '24x24', '2.5px', 'Creative Production — paint palette, spray can', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'services', 'ecommerce', 'icons/services/ecommerce.svg', '24x24', '2.5px', 'Ecommerce — shopping bag, storefront', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'services', 'launch-campaigns', 'icons/services/launch-campaigns.svg', '24x24', '2.5px', 'Launch Campaigns — megaphone, rocket', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'services', 'ops-consulting', 'icons/services/ops-consulting.svg', '24x24', '2.5px', 'Ops Consulting — clipboard, checklist', 0);

-- Action Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'actions', 'build', 'icons/actions/build.svg', '24x24', '2.5px', 'Build — hammer, wrench', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'actions', 'create', 'icons/actions/create.svg', '24x24', '2.5px', 'Create — pencil, brush', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'actions', 'launch', 'icons/actions/launch.svg', '24x24', '2.5px', 'Launch — rocket, arrow up', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'actions', 'connect', 'icons/actions/connect.svg', '24x24', '2.5px', 'Connect — link, handshake', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'actions', 'progress', 'icons/actions/progress.svg', '24x24', '2.5px', 'Progress — upward arrow, growth', 0);

-- Navigation Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'nav', 'services', 'icons/nav/services.svg', '24x24', '2.5px', 'Services — grid blocks', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'nav', 'work', 'icons/nav/work.svg', '24x24', '2.5px', 'Work — briefcase, toolbox', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'nav', 'team', 'icons/nav/team.svg', '24x24', '2.5px', 'Team — people, community', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'nav', 'contact', 'icons/nav/contact.svg', '24x24', '2.5px', 'Contact — speech bubble', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'nav', 'menu', 'icons/nav/menu.svg', '24x24', '2.5px', 'Menu — stacked lines', 0);

-- Status Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'status', 'active', 'icons/status/active.svg', '24x24', '2.5px', 'Active — filled circle with pulse', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'status', 'grinding', 'icons/status/grinding.svg', '24x24', '2.5px', 'Grinding — rotating gear', 1),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'status', 'complete', 'icons/status/complete.svg', '24x24', '2.5px', 'Complete — solid checkmark', 0),  
((SELECT id FROM brands WHERE slug = 'grindline-studio'), 'status', 'queued', 'icons/status/queued.svg', '24x24', '2.5px', 'Queued — stacked dots', 0);
