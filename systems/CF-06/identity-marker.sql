...
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline.build', '#F97316', '249, 115, 22', '0, 54, 91, 0', '1655 C', 'Build stage — orange, foundation work, initial creation', 1),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline.capture', '#06B6D4', '6, 182, 212', '75, 10, 15, 0', '311 C', 'Capture stage — cyan, collecting and gathering content', 1),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline.transform', '#84CC16', '132, 204, 22', '50, 0, 95, 0', '375 C', 'Transform stage — lime, processing and refining', 1),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline.publish', '#2563EB', '37, 99, 235', '85, 58, 0, 0', '2727 C', 'Publish stage — blue, deployment and distribution', 1),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline.measure', '#DB2777', '219, 39, 119', '10, 85, 20, 0', '213 C', 'Measure stage — pink, analytics and feedback', 1),

-- Neutral colors    
((SELECT id FROM brands WHERE slug = 'content-factor'), 'neutral.background', '#F9FAFB', '249, 250, 251', '2, 1, 1, 0', 'Cool Gray 1 C', 'Page base, light backgrounds', 0),    
((SELECT id FROM brands WHERE slug = 'content-factor'), 'neutral.surface', '#FFFFFF', '255, 255, 255', '0, 0, 0, 0', 'White', 'Cards, panels, white surfaces', 0),    
((SELECT id FROM brands WHERE slug = 'content-factor'), 'neutral.border', '#E5E7EB', '229, 231, 235', '8, 5, 4, 0', 'Cool Gray 2 C', 'Borders, dividers, separators', 0),    
    
-- Text colors    
((SELECT id FROM brands WHERE slug = 'content-factor'), 'text.primary', '#111827', '17, 24, 39', '85, 70, 55, 65', 'Black 6 C', 'Headings, primary content, high emphasis', 0),    
((SELECT id FROM brands WHERE slug = 'content-factor'), 'text.secondary', '#4B5563', '75, 85, 99', '55, 45, 35, 20', 'Cool Gray 11 C', 'Secondary text, muted content', 0);
...
VALUES  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline', 'build', 'icons/pipeline/build.svg', '24x24', '2px', 'Build stage — hammer/construction', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline', 'capture', 'icons/pipeline/capture.svg', '24x24', '2px', 'Capture stage — inbox/collection', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline', 'transform', 'icons/pipeline/transform.svg', '24x24', '2px', 'Transform stage — gears/processing', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline', 'publish', 'icons/pipeline/publish.svg', '24x24', '2px', 'Publish stage — rocket/deploy', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'pipeline', 'measure', 'icons/pipeline/measure.svg', '24x24', '2px', 'Measure stage — chart/analytics', 0);

-- Action Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'actions', 'play', 'icons/actions/play.svg', '24x24', '2px', 'Start pipeline', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'actions', 'pause', 'icons/actions/pause.svg', '24x24', '2px', 'Halt process', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'actions', 'refresh', 'icons/actions/refresh.svg', '24x24', '2px', 'Restart pipeline', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'actions', 'download', 'icons/actions/download.svg', '24x24', '2px', 'Export content', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'actions', 'upload', 'icons/actions/upload.svg', '24x24', '2px', 'Import content', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'actions', 'copy', 'icons/actions/copy.svg', '24x24', '2px', 'Duplicate content', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'actions', 'delete', 'icons/actions/delete.svg', '24x24', '2px', 'Remove content', 0);

-- Navigation Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'nav', 'dashboard', 'icons/nav/dashboard.svg', '24x24', '2px', 'Dashboard view — grid layout', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'nav', 'pipeline', 'icons/nav/pipeline.svg', '24x24', '2px', 'Pipeline view — flow diagram', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'nav', 'content', 'icons/nav/content.svg', '24x24', '2px', 'Content library — document stack', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'nav', 'settings', 'icons/nav/settings.svg', '24x24', '2px', 'Settings — gear icon', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'nav', 'logs', 'icons/nav/logs.svg', '24x24', '2px', 'Logs — terminal icon', 0);

-- Status Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'status', 'success', 'icons/status/success.svg', '24x24', '2px', 'Success — checkmark circle', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'status', 'warning', 'icons/status/warning.svg', '24x24', '2px', 'Warning — alert triangle', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'status', 'error', 'icons/status/error.svg', '24x24', '2px', 'Error — X circle', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'status', 'in-progress', 'icons/status/in-progress.svg', '24x24', '2px', 'In progress — spinning loader', 0),  
((SELECT id FROM brands WHERE slug = 'content-factor'), 'status', 'queued', 'icons/status/queued.svg', '24x24', '2px', 'Queued — clock icon', 0);
...
((SELECT id FROM brands WHERE slug = 'content-factor'), 'logo', 'icon', 'Factor X Icon', 'logo/factor-x-icon.svg', 'svg', 'X mark in circle — primary brand mark', 1),  
...
Each stage color is vibrant and distinct, making progress immediately visible.', 1),
