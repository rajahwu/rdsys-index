...
-- Style System is the parent brand, update it if it exists or create it  
...
'Confident, systematic, function-driven — built for clarity and scale',  
'Systematic · Operational · Permanent · Infrastructure · Clarity',  
NULL,  
datetime('now'),  
datetime('now')  
);
...
INSERT OR IGNORE INTO brands (name, slug, tagline, tone, keywords, parent_brand_id, created_at, updated_at)  
VALUES (  
'Style System',  
'style-system',  
...
((SELECT id FROM brands WHERE slug = 'style-system'), 'brand.primary', '#3B82F6', '59, 130, 246', '76, 47, 0, 0', '2727 C', 'Primary actions, highlights, key icons, brand identity', 1),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'brand.primary.light', '#60A5FA', '96, 165, 250', '62, 34, 0, 0', '2728 C', 'Hover states, secondary accents, lighter emphasis', 1),

-- Neutral scale (complete hierarchy)    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.900', '#111827', '17, 24, 39', '85, 70, 55, 65', 'Black 6 C', 'Headings, high-contrast text, primary emphasis', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.800', '#1F2937', '31, 41, 55', '75, 60, 45, 50', '533 C', 'Body text, primary content, readable dark', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.700', '#374151', '55, 65, 81', '65, 50, 40, 30', '532 C', 'Secondary headings, medium emphasis', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.600', '#4B5563', '75, 85, 99', '55, 45, 35, 20', 'Cool Gray 11 C', 'Tertiary text, subtle headings', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.500', '#6B7280', '107, 114, 128', '45, 35, 28, 5', 'Cool Gray 8 C', 'Secondary text, icon defaults, muted content', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.400', '#9CA3AF', '156, 163, 175', '30, 20, 15, 0', 'Cool Gray 5 C', 'Placeholder text, disabled states', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.300', '#D1D5DB', '209, 213, 219', '15, 10, 8, 0', 'Cool Gray 4 C', 'Borders, dividers, inactive elements', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.200', '#E5E7EB', '229, 231, 235', '8, 5, 4, 0', 'Cool Gray 2 C', 'Light borders, subtle separators', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.100', '#F3F4F6', '243, 244, 246', '4, 3, 2, 0', 'Cool Gray 1 C', 'Subtle backgrounds, hover states', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'neutral.50', '#F9FAFB', '249, 250, 251', '2, 1, 1, 0', 'White', 'Light backgrounds, card surfaces, page base', 0),    
    
-- Semantic accent colors    
((SELECT id FROM brands WHERE slug = 'style-system'), 'accent.success', '#10B981', '16, 185, 129', '70, 0, 55, 0', '3405 C', 'Success states, confirmations, positive feedback', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'accent.warning', '#F59E0B', '245, 158, 11', '0, 35, 95, 0', '130 C', 'Warnings, cautions, attention needed', 0),    
((SELECT id FROM brands WHERE slug = 'style-system'), 'accent.error', '#EF4444', '239, 68, 68', '0, 72, 72, 0', '1788 C', 'Errors, critical alerts, destructive actions', 0);
...
VALUES  
((SELECT id FROM brands WHERE slug = 'style-system'), 'tokens', 'color-swatch', 'icons/tokens/color-swatch.svg', '24x24', '2px', 'Color token representation', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'tokens', 'typography-a', 'icons/tokens/typography-a.svg', '24x24', '2px', 'Typography token representation', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'tokens', 'spacing-ruler', 'icons/tokens/spacing-ruler.svg', '24x24', '2px', 'Spacing token representation', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'tokens', 'shadow-layers', 'icons/tokens/shadow-layers.svg', '24x24', '2px', 'Shadow/elevation token representation', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'tokens', 'grid-template', 'icons/tokens/grid-template.svg', '24x24', '2px', 'Grid/layout token representation', 0);

-- Nav Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'style-system'), 'nav', 'tokens', 'icons/nav/tokens.svg', '24x24', '2px', 'Navigate to tokens section', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'nav', 'components', 'icons/nav/components.svg', '24x24', '2px', 'Navigate to components section', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'nav', 'docs', 'icons/nav/docs.svg', '24x24', '2px', 'Navigate to documentation', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'nav', 'search', 'icons/nav/search.svg', '24x24', '2px', 'Search functionality', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'nav', 'settings', 'icons/nav/settings.svg', '24x24', '2px', 'Settings/preferences', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'nav', 'home', 'icons/nav/home.svg', '24x24', '2px', 'Home/dashboard', 0);

-- Status Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'style-system'), 'status', 'success', 'icons/status/success.svg', '24x24', '2px', 'Success state checkmark', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'status', 'warning', 'icons/status/warning.svg', '24x24', '2px', 'Warning state triangle', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'status', 'error', 'icons/status/error.svg', '24x24', '2px', 'Error state X', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'status', 'info', 'icons/status/info.svg', '24x24', '2px', 'Information state circle', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'status', 'loading', 'icons/status/loading.svg', '24x24', '2px', 'Loading spinner', 0);

-- Action Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'style-system'), 'actions', 'edit', 'icons/actions/edit.svg', '24x24', '2px', 'Edit/modify action', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'actions', 'delete', 'icons/actions/delete.svg', '24x24', '2px', 'Delete/remove action', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'actions', 'copy', 'icons/actions/copy.svg', '24x24', '2px', 'Copy/duplicate action', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'actions', 'download', 'icons/actions/download.svg', '24x24', '2px', 'Download action', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'actions', 'upload', 'icons/actions/upload.svg', '24x24', '2px', 'Upload action', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'actions', 'add', 'icons/actions/add.svg', '24x24', '2px', 'Add/create action', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'actions', 'remove', 'icons/actions/remove.svg', '24x24', '2px', 'Remove/subtract action', 0);

-- UI Icons  
INSERT INTO brand_icons (brand_id, category, name, file_path, size, stroke_width, description, is_primary_glyph)  
VALUES  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'chevron-up', 'icons/ui/chevron-up.svg', '24x24', '2px', 'Chevron pointing up', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'chevron-down', 'icons/ui/chevron-down.svg', '24x24', '2px', 'Chevron pointing down', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'chevron-left', 'icons/ui/chevron-left.svg', '24x24', '2px', 'Chevron pointing left', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'chevron-right', 'icons/ui/chevron-right.svg', '24x24', '2px', 'Chevron pointing right', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'menu', 'icons/ui/menu.svg', '24x24', '2px', 'Menu hamburger icon', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'close', 'icons/ui/close.svg', '24x24', '2px', 'Close X icon', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'expand', 'icons/ui/expand.svg', '24x24', '2px', 'Expand arrows', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'collapse', 'icons/ui/collapse.svg', '24x24', '2px', 'Collapse icon', 0),  
((SELECT id FROM brands WHERE slug = 'style-system'), 'ui', 'external-link', 'icons/ui/external-link.svg', '24x24', '2px', 'External link indicator', 0);
...
Style System uses sophisticated blue (brand.primary) for trustworthy, professional identity. Complete neutral scale (50-900) provides comprehensive hierarchy for any UI need.', 1),
